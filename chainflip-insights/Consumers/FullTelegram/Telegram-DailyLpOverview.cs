            ...
            CancellationToken cancellationToken)
        {
            if (!_configuration.DiscordDailyLpOverviewEnabled.Value)
            {
                _logger.LogInformation(
                    "Daily LP Overview disabled for Full Telegram. {Date}",
            ...
            {
                _logger.LogInformation(
                    "Announcing Daily LP Overview for {Date} on Full Telegram.",
                    dailyLpOverviewInfo.Date.ToString("yyyy-MM-dd"));
                ...
                _logger.LogInformation(
                    "Announcing Daily LP Overview {Date} on Full Telegram as Message {MessageId}",
                    dailyLpOverviewInfo.Date.ToString("yyyy-MM-dd"),
                    message.MessageId);
            }
            catch (Exception e)
