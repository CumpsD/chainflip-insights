...
namespace Substrate.NetApiExt.Generated.Storage
{
    ...
    /// <summary>
    /// >> PolkadotThresholdSignerStorage
    /// </summary>
    public sealed class PolkadotThresholdSignerStorage
    {
        ...
        /// <summary>
        /// >> PolkadotThresholdSignerStorage Constructor
        /// </summary>
        public PolkadotThresholdSignerStorage(SubstrateClientExt client)
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("PolkadotThresholdSigner", "ThresholdSignatureRequestIdCounter"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Primitive.U32)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("PolkadotThresholdSigner", "PendingCeremonies"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U64), typeof(Substrate.NetApiExt.Generated.Model.pallet_cf_threshold_signature.pallet.CeremonyContextT2)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("PolkadotThresholdSigner", "PendingRequestInstructions"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U32), typeof(Substrate.NetApiExt.Generated.Model.pallet_cf_threshold_signature.pallet.RequestInstructionT2)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("PolkadotThresholdSigner", "RequestCallback"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("PolkadotThresholdSigner", "Signature"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("PolkadotThresholdSigner", "CeremonyRetryQueues"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
        ...
        {
            return RequestGenerator.GetStorage("PolkadotThresholdSigner", "ThresholdSignatureRequestIdCounter", Substrate.NetApi.Model.Meta.Storage.Type.Plain);
        }
        ...
        {
            string parameters = PolkadotThresholdSignerStorage.ThresholdSignatureRequestIdCounterParams();
        ...
        {
            return RequestGenerator.GetStorage("PolkadotThresholdSigner", "PendingCeremonies", Substrate.NetApi.Model.Meta.Storage.Type.Map, new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
        ...
        ///  Stores the context required for processing live ceremonies.
        /// </summary>
        public async Task<Substrate.NetApiExt.Generated.Model.pallet_cf_threshold_signature.pallet.CeremonyContextT2> PendingCeremonies(Substrate.NetApi.Model.Types.Primitive.U64 key, string blockhash, CancellationToken token)
        {
            string parameters = PolkadotThresholdSignerStorage.PendingCeremoniesParams(key);
            var result = await _client.GetStorageAsync<Substrate.NetApiExt.Generated.Model.pallet_cf_threshold_signature.pallet.CeremonyContextT2>(parameters, blockhash, token);
            return result;
        }
        ...
        {
            return RequestGenerator.GetStorage("PolkadotThresholdSigner", "PendingRequestInstructions", Substrate.NetApi.Model.Meta.Storage.Type.Map, new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                        Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, new Substrate.NetApi.Model.Types.IType[] {
                        key});
        }
        ...
        /// </summary>
        public async Task<Substrate.NetApiExt.Generated.Model.pallet_cf_threshold_signature.pallet.RequestInstructionT2> PendingRequestInstructions(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
            string parameters = PolkadotThresholdSignerStorage.PendingRequestInstructionsParams(key);
            var result = await _client.GetStorageAsync<Substrate.NetApiExt.Generated.Model.pallet_cf_threshold_signature.pallet.RequestInstructionT2>(parameters, blockhash, token);
            return result;
        }
        ...
        {
            return RequestGenerator.GetStorage("PolkadotThresholdSigner", "RequestCallback", Substrate.NetApi.Model.Meta.Storage.Type.Map, new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                        Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, new Substrate.NetApi.Model.Types.IType[] {
                        key});
        }
        ...
        {
            string parameters = PolkadotThresholdSignerStorage.RequestCallbackParams(key);
        ...
        {
            return RequestGenerator.GetStorage("PolkadotThresholdSigner", "Signature", Substrate.NetApi.Model.Meta.Storage.Type.Map, new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                        Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, new Substrate.NetApi.Model.Types.IType[] {
                        key});
        }
        ...
        {
            string parameters = PolkadotThresholdSignerStorage.SignatureParams(key);
        ...
        {
            return RequestGenerator.GetStorage("PolkadotThresholdSigner", "CeremonyRetryQueues", Substrate.NetApi.Model.Meta.Storage.Type.Map, new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                        Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, new Substrate.NetApi.Model.Types.IType[] {
                        key});
        }
        ...
        {
            string parameters = PolkadotThresholdSignerStorage.CeremonyRetryQueuesParams(key);
        ...
        {
            return RequestGenerator.GetStorage("PolkadotThresholdSigner", "RequestRetryQueue", Substrate.NetApi.Model.Meta.Storage.Type.Map, new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                        Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, new Substrate.NetApi.Model.Types.IType[] {
                        key});
        }
        ...
        {
            string parameters = PolkadotThresholdSignerStorage.RequestRetryQueueParams(key);
        ...
        {
            return RequestGenerator.GetStorage("PolkadotThresholdSigner", "ThresholdSignatureResponseTimeout", Substrate.NetApi.Model.Meta.Storage.Type.Plain);
        }
    ...
    /// <summary>
    /// >> PolkadotThresholdSignerCalls
    /// </summary>
    public sealed class PolkadotThresholdSignerCalls
    {
        ...
        /// </summary>
        public static Method SignatureSuccess(Substrate.NetApi.Model.Types.Primitive.U64 ceremony_id, Substrate.NetApiExt.Generated.Model.cf_chains.dot.PolkadotSignature signature)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(ceremony_id.Encode());
            byteArray.AddRange(signature.Encode());
            return new Method(25, "PolkadotThresholdSigner", 0, "signature_success", byteArray.ToArray());
        }
        ...
        public static Method ReportSignatureFailed(Substrate.NetApi.Model.Types.Primitive.U64 ceremony_id, Substrate.NetApiExt.Generated.Types.Base.BTreeSetT1 offenders)
        {
            ...
            return new Method(25, "PolkadotThresholdSigner", 1, "report_signature_failed", byteArray.ToArray());
        }
    ...
    /// <summary>
    /// >> PolkadotThresholdSignerConstants
    /// </summary>
    public sealed class PolkadotThresholdSignerConstants
    {
    ...
    /// <summary>
    /// >> PolkadotThresholdSignerErrors
    /// </summary>
    public enum PolkadotThresholdSignerErrors
    {
