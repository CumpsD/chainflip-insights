...
namespace Substrate.NetApiExt.Generated.Storage
{
    ...
    /// <summary>
    /// >> PolkadotVaultStorage
    /// </summary>
    public sealed class PolkadotVaultStorage
    {
        ...
        /// <summary>
        /// >> PolkadotVaultStorage Constructor
        /// </summary>
        public PolkadotVaultStorage(SubstrateClientExt client)
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("PolkadotVault", "Vaults"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U32), typeof(Substrate.NetApiExt.Generated.Model.pallet_cf_vaults.VaultT2)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("PolkadotVault", "CurrentVaultEpoch"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Primitive.U32)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("PolkadotVault", "PendingVaultRotation"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApiExt.Generated.Model.pallet_cf_vaults.EnumVaultRotationStatus)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("PolkadotVault", "KeygenSuccessVoters"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("PolkadotVault", "KeygenFailureVoters"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("PolkadotVault", "KeyHandoverSuccessVoters"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Identity}, typeof(Substrate.NetApiExt.Generated.Model.cf_chains.dot.PolkadotAccountId), typeof(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("PolkadotVault", "KeyHandoverFailureVoters"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("PolkadotVault", "KeygenResolutionPendingSince"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Primitive.U32)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("PolkadotVault", "KeyHandoverResolutionPendingSince"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Primitive.U32)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("PolkadotVault", "KeygenResponseTimeout"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Primitive.U32)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("PolkadotVault", "KeygenSlashAmount"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Primitive.U128)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("PolkadotVault", "CeremonyIdCounter"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Primitive.U64)));
        }
        ...
        {
            return RequestGenerator.GetStorage("PolkadotVault", "Vaults", Substrate.NetApi.Model.Meta.Storage.Type.Map, new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
        ...
        ///  A map of vaults by epoch.
        /// </summary>
        public async Task<Substrate.NetApiExt.Generated.Model.pallet_cf_vaults.VaultT2> Vaults(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
            string parameters = PolkadotVaultStorage.VaultsParams(key);
            var result = await _client.GetStorageAsync<Substrate.NetApiExt.Generated.Model.pallet_cf_vaults.VaultT2>(parameters, blockhash, token);
            return result;
        }
        ...
        {
            return RequestGenerator.GetStorage("PolkadotVault", "CurrentVaultEpoch", Substrate.NetApi.Model.Meta.Storage.Type.Plain);
        }
        ...
        {
            string parameters = PolkadotVaultStorage.CurrentVaultEpochParams();
        ...
        {
            return RequestGenerator.GetStorage("PolkadotVault", "PendingVaultRotation", Substrate.NetApi.Model.Meta.Storage.Type.Plain);
        }
        ...
        {
            string parameters = PolkadotVaultStorage.PendingVaultRotationParams();
        ...
        {
            return RequestGenerator.GetStorage("PolkadotVault", "KeygenSuccessVoters", Substrate.NetApi.Model.Meta.Storage.Type.Map, new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
        ...
        {
            string parameters = PolkadotVaultStorage.KeygenSuccessVotersParams(key);
        ...
        {
            return RequestGenerator.GetStorage("PolkadotVault", "KeygenFailureVoters", Substrate.NetApi.Model.Meta.Storage.Type.Plain);
        }
        ...
        {
            string parameters = PolkadotVaultStorage.KeygenFailureVotersParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>>(parameters, blockhash, token);
            return result;
        }
        ...
        {
            return RequestGenerator.GetStorage("PolkadotVault", "KeyHandoverSuccessVoters", Substrate.NetApi.Model.Meta.Storage.Type.Map, new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                        Substrate.NetApi.Model.Meta.Storage.Hasher.Identity}, new Substrate.NetApi.Model.Types.IType[] {
                        key});
        }
        ...
        {
            string parameters = PolkadotVaultStorage.KeyHandoverSuccessVotersParams(key);
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>>(parameters, blockhash, token);
            return result;
        }
        ...
        {
            return RequestGenerator.GetStorage("PolkadotVault", "KeyHandoverFailureVoters", Substrate.NetApi.Model.Meta.Storage.Type.Plain);
        }
        ...
        {
            string parameters = PolkadotVaultStorage.KeyHandoverFailureVotersParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>>(parameters, blockhash, token);
            return result;
        }
        ...
        {
            return RequestGenerator.GetStorage("PolkadotVault", "KeygenResolutionPendingSince", Substrate.NetApi.Model.Meta.Storage.Type.Plain);
        }
        ...
        {
            string parameters = PolkadotVaultStorage.KeygenResolutionPendingSinceParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Primitive.U32>(parameters, blockhash, token);
            return result;
        }
        ...
        {
            return RequestGenerator.GetStorage("PolkadotVault", "KeyHandoverResolutionPendingSince", Substrate.NetApi.Model.Meta.Storage.Type.Plain);
        }
        ...
        {
            string parameters = PolkadotVaultStorage.KeyHandoverResolutionPendingSinceParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Primitive.U32>(parameters, blockhash, token);
            return result;
        }
        ...
        {
            return RequestGenerator.GetStorage("PolkadotVault", "KeygenResponseTimeout", Substrate.NetApi.Model.Meta.Storage.Type.Plain);
        }
        ...
        {
            string parameters = PolkadotVaultStorage.KeygenResponseTimeoutParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Primitive.U32>(parameters, blockhash, token);
            return result;
        }
        ...
        {
            return RequestGenerator.GetStorage("PolkadotVault", "KeygenSlashAmount", Substrate.NetApi.Model.Meta.Storage.Type.Plain);
        }
        ...
        {
            string parameters = PolkadotVaultStorage.KeygenSlashAmountParams();
        ...
        {
            return RequestGenerator.GetStorage("PolkadotVault", "CeremonyIdCounter", Substrate.NetApi.Model.Meta.Storage.Type.Plain);
        }
        ...
        {
            string parameters = PolkadotVaultStorage.CeremonyIdCounterParams();
    ...
    /// >> PolkadotVaultCalls
    /// </summary>
    public sealed class PolkadotVaultCalls
    {
        ...
        public static Method ReportKeygenOutcome(Substrate.NetApi.Model.Types.Primitive.U64 ceremony_id, Substrate.NetApiExt.Generated.Types.Base.EnumResult reported_outcome)
        {
            ...
            return new Method(22, "PolkadotVault", 0, "report_keygen_outcome", byteArray.ToArray());
        }
        ...
        public static Method ReportKeyHandoverOutcome(Substrate.NetApi.Model.Types.Primitive.U64 ceremony_id, Substrate.NetApiExt.Generated.Types.Base.EnumResult reported_outcome)
        {
            ...
            byteArray.AddRange(ceremony_id.Encode());
            byteArray.AddRange(reported_outcome.Encode());
            return new Method(22, "PolkadotVault", 1, "report_key_handover_outcome", byteArray.ToArray());
        }
        ...
        public static Method OnKeygenVerificationResult(Substrate.NetApi.Model.Types.Primitive.U64 keygen_ceremony_id, Substrate.NetApi.Model.Types.Primitive.U32 threshold_request_id, Substrate.NetApiExt.Generated.Model.cf_chains.dot.PolkadotAccountId new_public_key)
        {
            ...
            return new Method(22, "PolkadotVault", 2, "on_keygen_verification_result", byteArray.ToArray());
        }
        ...
        public static Method OnHandoverVerificationResult(Substrate.NetApi.Model.Types.Primitive.U64 handover_ceremony_id, Substrate.NetApi.Model.Types.Primitive.U32 threshold_request_id, Substrate.NetApiExt.Generated.Model.cf_chains.dot.PolkadotAccountId new_public_key)
        {
            ...
            byteArray.AddRange(threshold_request_id.Encode());
            byteArray.AddRange(new_public_key.Encode());
            return new Method(22, "PolkadotVault", 7, "on_handover_verification_result", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method VaultKeyRotated(Substrate.NetApi.Model.Types.Primitive.U32 block_number, Substrate.NetApiExt.Generated.Model.cf_primitives.TxId tx_id)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(block_number.Encode());
            byteArray.AddRange(tx_id.Encode());
            return new Method(22, "PolkadotVault", 3, "vault_key_rotated", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method VaultKeyRotatedExternally(Substrate.NetApiExt.Generated.Model.cf_chains.dot.PolkadotAccountId new_public_key, Substrate.NetApi.Model.Types.Primitive.U32 block_number, Substrate.NetApiExt.Generated.Model.cf_primitives.TxId tx_id)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(new_public_key.Encode());
            byteArray.AddRange(block_number.Encode());
            byteArray.AddRange(tx_id.Encode());
            return new Method(22, "PolkadotVault", 4, "vault_key_rotated_externally", byteArray.ToArray());
        }
        ...
        public static Method SetKeygenResponseTimeout(Substrate.NetApi.Model.Types.Primitive.U32 new_timeout)
        {
            ...
            return new Method(22, "PolkadotVault", 5, "set_keygen_response_timeout", byteArray.ToArray());
        }
        ...
        public static Method SetKeygenSlashAmount(Substrate.NetApi.Model.Types.Primitive.U128 amount_to_slash)
        {
            ...
            return new Method(22, "PolkadotVault", 6, "set_keygen_slash_amount", byteArray.ToArray());
        }
    }
    
    /// <summary>
    /// >> PolkadotVaultConstants
    /// </summary>
    public sealed class PolkadotVaultConstants
    {
    }
    ...
    /// >> PolkadotVaultErrors
    /// </summary>
    public enum PolkadotVaultErrors
    {
