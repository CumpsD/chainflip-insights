...
namespace Substrate.NetApiExt.Generated.Storage
{
    ...
    public sealed class BitcoinVaultStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("BitcoinVault", "VaultStartBlockNumbers"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("BitcoinVault", "PendingVaultActivation"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApiExt.Generated.Model.pallet_cf_vaults.EnumVaultActivationStatus)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("BitcoinVault", "ChainInitialized"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Primitive.Bool)));
        }
        ...
        {
            return RequestGenerator.GetStorage("BitcoinVault", "VaultStartBlockNumbers", Substrate.NetApi.Model.Meta.Storage.Type.Map, new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
        ...
        {
            string parameters = BitcoinVaultStorage.VaultStartBlockNumbersParams(key);
        ...
        {
            return RequestGenerator.GetStorage("BitcoinVault", "PendingVaultActivation", Substrate.NetApi.Model.Meta.Storage.Type.Plain);
        }
        ...
        {
            string parameters = BitcoinVaultStorage.PendingVaultActivationParams();
        ...
        {
            return RequestGenerator.GetStorage("BitcoinVault", "ChainInitialized", Substrate.NetApi.Model.Meta.Storage.Type.Plain);
        }
        ...
        {
            string parameters = BitcoinVaultStorage.ChainInitializedParams();
    ...
    public sealed class BitcoinVaultCalls
    {
        ...
        /// </summary>
        public static Method VaultKeyRotatedExternally(Substrate.NetApiExt.Generated.Model.cf_chains.btc.AggKey new_public_key, Substrate.NetApi.Model.Types.Primitive.U64 block_number, Substrate.NetApiExt.Generated.Model.primitive_types.H256 tx_id)
        {
        ...
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            return new Method(23, "BitcoinVault", 5, "initialize_chain", byteArray.ToArray());
        }
    }
