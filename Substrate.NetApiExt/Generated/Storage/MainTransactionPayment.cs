...
namespace Substrate.NetApiExt.Generated.Storage
{
    ...
    public sealed class TransactionPaymentStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("TransactionPayment", "NextFeeMultiplier"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApiExt.Generated.Model.sp_arithmetic.fixed_point.FixedU128)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("TransactionPayment", "StorageVersion"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApiExt.Generated.Model.pallet_transaction_payment.EnumReleases)));
        }
        ...
        /// >> NextFeeMultiplier
        /// </summary>
        public async Task<Substrate.NetApiExt.Generated.Model.sp_arithmetic.fixed_point.FixedU128> NextFeeMultiplier(string blockhash, CancellationToken token)
        {
        ...
        /// >> StorageVersion
        /// </summary>
        public async Task<Substrate.NetApiExt.Generated.Model.pallet_transaction_payment.EnumReleases> StorageVersion(string blockhash, CancellationToken token)
        {
            string parameters = TransactionPaymentStorage.StorageVersionParams();
            var result = await _client.GetStorageAsync<Substrate.NetApiExt.Generated.Model.pallet_transaction_payment.EnumReleases>(parameters, blockhash, token);
            return result;
        }
    }
