...
namespace Substrate.NetApiExt.Generated.Storage
{
    ...
    public sealed class GrandpaStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Grandpa", "State"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApiExt.Generated.Model.pallet_grandpa.EnumStoredState)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Grandpa", "PendingChange"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApiExt.Generated.Model.pallet_grandpa.StoredPendingChange)));
        ...
        ///  State of the current authority set.
        /// </summary>
        public async Task<Substrate.NetApiExt.Generated.Model.pallet_grandpa.EnumStoredState> State(string blockhash, CancellationToken token)
        {
            string parameters = GrandpaStorage.StateParams();
            var result = await _client.GetStorageAsync<Substrate.NetApiExt.Generated.Model.pallet_grandpa.EnumStoredState>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  Pending change: (signaled at, scheduled change).
        /// </summary>
        public async Task<Substrate.NetApiExt.Generated.Model.pallet_grandpa.StoredPendingChange> PendingChange(string blockhash, CancellationToken token)
        {
            string parameters = GrandpaStorage.PendingChangeParams();
            var result = await _client.GetStorageAsync<Substrate.NetApiExt.Generated.Model.pallet_grandpa.StoredPendingChange>(parameters, blockhash, token);
            return result;
        }
    ...
    public sealed class GrandpaCalls
    {
        ...
        /// </summary>
        public static Method ReportEquivocation(Substrate.NetApiExt.Generated.Model.sp_consensus_grandpa.EquivocationProof equivocation_proof, Substrate.NetApiExt.Generated.Model.sp_session.MembershipProof key_owner_proof)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(equivocation_proof.Encode());
            byteArray.AddRange(key_owner_proof.Encode());
            return new Method(14, "Grandpa", 0, "report_equivocation", byteArray.ToArray());
        }
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method ReportEquivocationUnsigned(Substrate.NetApiExt.Generated.Model.sp_consensus_grandpa.EquivocationProof equivocation_proof, Substrate.NetApiExt.Generated.Model.sp_session.MembershipProof key_owner_proof)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(equivocation_proof.Encode());
            byteArray.AddRange(key_owner_proof.Encode());
            return new Method(14, "Grandpa", 1, "report_equivocation_unsigned", byteArray.ToArray());
        }
        ...
        public static Method NoteStalled(Substrate.NetApi.Model.Types.Primitive.U32 delay, Substrate.NetApi.Model.Types.Primitive.U32 best_finalized_block_number)
        {
            ...
            return new Method(14, "Grandpa", 2, "note_stalled", byteArray.ToArray());
        }
    }
    ...
    public sealed class GrandpaConstants
    {
        ...
        public Substrate.NetApi.Model.Types.Primitive.U64 MaxSetIdSessionEntries()
        {
            ...
            result.Create("0x0800000000000000");
            return result;
        }
    }
