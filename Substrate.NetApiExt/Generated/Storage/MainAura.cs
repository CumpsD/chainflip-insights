...
namespace Substrate.NetApiExt.Generated.Storage
{
    ...
    public sealed class AuraStorage
    {
        ...
        ///  This will be set in `on_initialize`.
        /// </summary>
        public async Task<Substrate.NetApiExt.Generated.Model.sp_consensus_slots.Slot> CurrentSlot(string blockhash, CancellationToken token)
        {
            string parameters = AuraStorage.CurrentSlotParams();
            var result = await _client.GetStorageAsync<Substrate.NetApiExt.Generated.Model.sp_consensus_slots.Slot>(parameters, blockhash, token);
            return result;
        }
    }
