...
namespace Substrate.NetApiExt.Generated.Model.cfe_events
{
    ...
    /// <summary>
    /// >> 653 - Composite[cfe_events.TxBroadcastRequestT4]
    /// </summary>
    [SubstrateNodeType(TypeDefEnum.Composite)]
    public sealed class TxBroadcastRequestT4 : BaseType
    {
        ...
        /// >> payload
        /// </summary>
        public Substrate.NetApiExt.Generated.Model.cf_chains.evm.Transaction Payload { get; set; }
        
        /// <inheritdoc/>
        public override string TypeName()
        {
            return "TxBroadcastRequestT4";
        }
        ...
        public override void Decode(byte[] byteArray, ref int p)
        {
            ...
            Payload = new Substrate.NetApiExt.Generated.Model.cf_chains.evm.Transaction();
