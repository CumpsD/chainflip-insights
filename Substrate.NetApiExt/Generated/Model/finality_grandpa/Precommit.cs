...
namespace Substrate.NetApiExt.Generated.Model.finality_grandpa
{
    ...
    /// <summary>
    /// >> 106 - Composite[finality_grandpa.Precommit]
    /// </summary>
    ...
    public sealed class Precommit : BaseType
    {
        ...
        /// >> target_hash
        /// </summary>
        public Substrate.NetApiExt.Generated.Model.primitive_types.H256 TargetHash { get; set; }
        /// <summary>
        /// >> target_number
        /// </summary>
        ...
        {
            var start = p;
            TargetHash = new Substrate.NetApiExt.Generated.Model.primitive_types.H256();
