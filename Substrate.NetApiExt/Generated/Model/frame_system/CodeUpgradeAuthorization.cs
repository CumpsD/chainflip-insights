...
namespace Substrate.NetApiExt.Generated.Model.frame_system
{
    ...
    /// <summary>
    /// >> 371 - Composite[frame_system.CodeUpgradeAuthorization]
    /// </summary>
    ...
    public sealed class CodeUpgradeAuthorization : BaseType
    {
        ...
        /// >> code_hash
        /// </summary>
        public Substrate.NetApiExt.Generated.Model.primitive_types.H256 CodeHash { get; set; }
        /// <summary>
        /// >> check_version
        /// </summary>
        ...
        {
            var start = p;
            CodeHash = new Substrate.NetApiExt.Generated.Model.primitive_types.H256();
